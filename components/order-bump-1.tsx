...
const DECLINE_URL = "/orderbumpcombo"

const benefits = [
  "50 coberturas y toppings premium para tus paletas",
  "Combinaciones gourmet que elevan el sabor y la presentación",
  "Ideas para vender paletas más caras y con más margen",
  "Recetas fáciles de preparar con ingredientes accesibles",
  "Toppings crujientes, cremosos y decorativos para sorprender",
  "Acceso digital inmediato, incluso para principiantes",
]

export function OrderBump1() {
  return (
        ...
        <div className="mt-6 overflow-hidden rounded-3xl bg-card shadow-xl shadow-chocolate/10">
          ...
          <div className="p-6">
            ...
            <p className="mt-2 text-center text-sm font-medium leading-relaxed text-muted-foreground text-pretty">
              Transforma paletas simples en creaciones gourmet irresistibles. Con estas coberturas y toppings vas a
              cobrar más y a destacar frente a la competencia.
            </p>

            <div className="mx-auto mt-5 overflow-hidden rounded-2xl">
              <Image
                src="/images/50-coberturas-toppings-premium.png"
                alt="50 coberturas y toppings premium para decorar y dar más valor a las paletas rellenas"
                width={1024}
                height={1024}
            ...
            <div className="mt-6 text-center">
              <p className="mt-1 font-display text-5xl font-extrabold text-primary">$2,00</p>
            ...
            <div className="mt-6">
              ...
              >
                <span className="leading-tight">SÍ, QUIERO AGREGAR ESTOS TOPPINGS</span>
